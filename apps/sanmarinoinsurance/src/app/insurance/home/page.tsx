        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          ...
          <div className="border border-foreground/20 bg-surface/60 p-7">
            <div className="border border-foreground/20 bg-background/35 p-4">
              <HomeIllustration className="h-[132px] w-full text-foreground" />
            </div>
...
function QuickFocusCard({
  ...
  return (
    <div className="border border-foreground/20 bg-background/25 p-4">
      <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
        <span className="inline-flex size-7 items-center justify-center border border-foreground/20 bg-background/35 text-foreground">
          {icon}
        </span>
        {title}
      </div>
...
function SavingsCard({ title, body }: { title: string; body: string }) {
  return (
