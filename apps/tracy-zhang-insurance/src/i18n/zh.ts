...
> = {
  "why-you-should-consider-the-ca-fair-plan": {
    ...
    readingMinutes: 6,
    tags: ["FAIR Plan", "房屋保险", "加州财产", "续保"],
    sections: [
      {
        type: "quote",
        text: "如果你的加州房屋保险被取消、不续保、涨价太多，或突然很难找到承保，不要自动接受最昂贵的特殊市场报价。CA FAIR Plan 有时可以先处理最难承保的火灾风险，再用合适的补充保障把其他缺口补上。",
      },
      {
        type: "p",
        text: "加州房屋保险出现问题时，很多房主会突然感到压力。通知可能来自邮件、续保文件或贷款方要求。房子没有变，家庭也没有突然变得更危险，但保险公司对这个风险的看法变了。",
      },
      {
        type: "p",
        text: "可能是 nonrenewal，不再续保。可能是保费涨到让人难以接受。也可能只剩一个特殊市场或非 admitted carrier 的报价，价格高到让房主怀疑自己是在买保障，还是被时间压力逼着接受。",
      },
      {
        type: "h2",
        text: "FAIR Plan 不一定只是最后选择",
      },
      {
        type: "p",
        text: "很多人听到 FAIR Plan，会以为这是最后一步、备用方案，或所有正常选择都消失以后才会用到的东西。这有一部分事实，但不是完整的判断方式。",
      },
      {
        type: "p",
        text: "在现在的加州保险市场，FAIR Plan 有时不是失败信号，而是避免做出更差决定的工具。真正的问题不是 FAIR Plan 听起来是不是理想，而是它和你面前的其他选择相比，能不能形成更好的保障结构。",
      },
      {
        type: "h2",
        text: "先处理真正卡住的风险",
      ...
      {
        type: "p",
        text: "对许多加州房屋来说，火灾风险是让标准市场退缩的关键。房屋本身可能维护得很好，但所在地区或 wildfire exposure 让标准承保公司不愿意接受。",
      },
      {
        type: "p",
        text: "这时，特殊市场报价可能是合适答案，也可能只是最早出现、最昂贵的答案。availability 很重要，但有报价不等于有价值。",
      },
      {
        type: "p",
        text: "FAIR Plan 的作用，是有机会把火灾这一部分风险先直接处理。然后再看传统 homeowners policy 里其他重要部分：责任险、盗窃、水损、个人财产、loss of use、贷款要求和免赔额选择。",
      },
      {
        type: "h2",
        text: "这不是将就，而是结构化",
      ...
      {
        type: "p",
        text: "如果火灾风险是标准市场无法接受的原因，就应该清楚地把这个问题拿出来处理。之后再决定需要什么 companion coverage 或其他补充保障，而不是默认一份高价特殊市场保单一定更安全。",
      },
      {
        type: "p",
        text: "最糟糕的决定，是把高保费等同于强保障。贵的保险也可能有缺口，特殊市场保单也可能有除外责任，便宜方案也可能保障太薄，FAIR Plan 也可能有重要限制。不能只用价格判断。",
      },
      {
        type: "ul",
        items: [
      ...
      {
        type: "h2",
        text: "Tracy Zhang 可以帮你比较真实选择",
      },
      {
        type: "p",
        text: "如果你被取消、不续保、收到不合理涨价，或被推向很贵的保单，Tracy 可以帮你把决定慢下来，逐项比较。重点不是讲一堆术语，而是说明每个选择做什么、不做什么、哪里有成本合理性、哪里可能有缺口。",
      },
      {
        type: "p",
        text: "请把续保文件、nonrenewal letter、让你生气的报价，或你不确定怎么判断的 FAIR Plan 选项带来。Tracy Zhang 可以帮助你围绕真实风险建立一个更清楚的方案。",
      },
      {
        type: "p",
        text: "目标不只是买到保险，而是避免为了错误答案付出过高代价。",
      },
      {
        type: "p",
        text: "注：本文为一般信息，不会绑定、变更、续保或取消任何保险。FAIR Plan、补充保障、特殊市场可得性、价格、资格和保单条款，都取决于具体房屋、承保规则、核保和当时项目要求。",
      },
    ],
  },
